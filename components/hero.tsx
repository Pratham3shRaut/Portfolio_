...
export function Hero() {
  ...
  return <section onPointerMove={e => { mx.set((e.clientX / innerWidth - .5) * 36); my.set((e.clientY / innerHeight - .5) * 24); }} className="relative flex min-h-[94svh] items-end overflow-hidden pb-16 pt-28 sm:pt-32 md:pb-20 md:pt-36">
    ...
    <motion.div style={{ x, y }} className="pointer-events-none absolute right-[-11rem] top-[62%] hidden h-[15rem] w-[15rem] -translate-y-1/2 rounded-full border border-signal/40 opacity-70 sm:block sm:h-[18rem] sm:w-[18rem] lg:right-[2%] lg:top-auto lg:bottom-[-4rem] lg:h-[24rem] lg:w-[24rem] lg:translate-y-0 xl:bottom-[-6rem] xl:right-[2%] xl:h-[30rem] xl:w-[30rem]">
      {hasPortrait ? (
    ...
    <div className="frame relative z-10">
      ...
      <motion.h1 style={{ y: titleY, opacity: titleOpacity }} className="balance max-w-[1100px] font-display text-[clamp(4rem,9vw,8.4rem)] font-semibold leading-[.84] tracking-[-.072em]">
